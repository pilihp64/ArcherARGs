...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8"/>
		<link rel="stylesheet" type="text/css" href="game_stylesheet.css">
	...
	<!-- Game by Tim Farrell -->
	<!-- Music by Myke Chapman -->
	<!-- Titles by Mark Paterson -->
	
        <!-- Set the title bar of the page -->
        <title>YOU'RE NOT MY SUPERVISOR!!</title>
<script>
  (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
  (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),
  m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)
...
<body>
        ...
        <script type="text/javascript" src="html5game/Cheryl_Original.js?KRDYB=787844837"></script>
